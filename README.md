...
- **[`docs/superpowers/specs/`](docs/superpowers/specs/)** and
  **[`docs/superpowers/plans/`](docs/superpowers/plans/)** — design
  specs and implementation plans from the Superpowers methodology
  (the most recent is the 2026-05-06 ZPL textarea + PDF-preview
  redesign).
